...
public:
  ...
  virtual C_CKSTRING GetID() override { return "PositionViewer"; }
  virtual C_CKSTRING GetVersion() override { return "0.0.1"; }
  virtual C_CKSTRING GetName() override { return "Position Viewer"; }
  virtual C_CKSTRING GetAuthor() override { return "BallanceBug"; }
  virtual C_CKSTRING GetDescription() override { return "Displays the coordinates of your player ball."; }
  DECLARE_BML_VERSION;
